...
export async function getAllEntitledProvidersForOrg (eventsClient, consumerId) {
...
export async function selectProviderForProviderMetadata (providerMetadataToProvidersMap,
...
export async function selectEventMetadataForProvider (providerSelected, eventMetadataChoices, obj) {
