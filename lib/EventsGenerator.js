...
import { promptForEventsOfInterest, getProviderMetadataToProvidersExistingMap } from './events/EventsOfInterestHelper.js'
import { promptForRuntimeAction } from './events/RuntimeActionForEventsHelper.js'
...
class EventsGenerator extends ActionGenerator {
  ...
  async initEventsClient () {
    ...
    const accessToken = await imsLib.getToken(CLI)
